...
<p><?php
	printf(
		...
		__( 'Excerpts are optional hand-crafted summaries of your content that can be used in your theme. <a href="%s">Saber más about manual excerpts</a>.' ),
...
<p><?php _e('If the link is to a person, you can specify your relationship with them using the above form. If you would like to Saber más about the idea check out <a href="http://gmpg.org/xfn/">XFN</a>.'); ?></p>
<?php
}
